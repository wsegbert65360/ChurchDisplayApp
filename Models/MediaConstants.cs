...
public static class MediaConstants
{
    ...
    // ⚡ Bolt: Using zero-allocation approach (AsSpan + OrdinalIgnoreCase) to prevent string allocations
    // and reduce GC pressure on high-frequency paths. Expected impact: eliminates string allocations per check.
    public static bool IsImage(string filePath)
    {
        ...
        {
            if (ext.Equals(extension.AsSpan(), StringComparison.OrdinalIgnoreCase))
                return true;
        }
        return false;
    }
