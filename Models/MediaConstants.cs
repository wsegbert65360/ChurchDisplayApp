...
public static class MediaConstants
{
    ...
    {
        // ⚡ Bolt: Zero-allocation extension check to reduce GC pressure on high-frequency paths.
        // Uses AsSpan() which safely returns an empty span if filePath is null, preventing NREs.
