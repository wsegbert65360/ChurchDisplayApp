...
public static class MediaConstants
{
    ...
    {
        // Zero-allocation string matching to reduce GC pressure
    ...
    public static bool IsVideo(string filePath)
    {
        ...
        {
            if (ext.Equals(videoExt.AsSpan(), StringComparison.OrdinalIgnoreCase))
                return true;
        }
        return false;
    }
    ...
    public static bool IsAudio(string filePath)
    {
        ...
        {
            if (ext.Equals(audioExt.AsSpan(), StringComparison.OrdinalIgnoreCase))
                return true;
        }
        return false;
    }
