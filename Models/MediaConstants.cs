...
public static class MediaConstants
{
    ...
    public static bool IsImage(string filePath)
    {
        ...
        // ⚡ Bolt: Use ReadOnlySpan<char> and OrdinalIgnoreCase to eliminate string allocations
        // Expected impact: Prevents heap allocations and reduces GC pressure during mass evaluations.
