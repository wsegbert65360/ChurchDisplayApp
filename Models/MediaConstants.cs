...
public static class MediaConstants
{
    ...
    {
        // ⚡ Bolt Performance: Use ReadOnlySpan to avoid string allocations,
        // and loop with OrdinalIgnoreCase instead of LINQ Contains + ToLower
    ...
    {
        // ⚡ Bolt Performance: Zero-allocation extension check
        var ext = System.IO.Path.GetExtension(filePath.AsSpan());
