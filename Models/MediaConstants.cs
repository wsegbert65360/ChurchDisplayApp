...
public static class MediaConstants
{
    ...
    // Performance optimization: Using ReadOnlySpan<char> and explicit loops with StringComparison.OrdinalIgnoreCase
    // to eliminate string allocations (.ToLower()) and LINQ/boxing overhead (.Contains()) in high-frequency checks.
